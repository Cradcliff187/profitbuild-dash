 ...
 * Generated at: 2026-07-01T13:50:24.343Z
...
export const KPI_CONTEXT = {
  version: '4.0.0',
  generatedAt: '2026-07-01T13:50:24.343Z',
  sourceLastUpdated: '2026-04-12',
  ...
  "overtime": "expenses.gross_hours",
  "ot": "expenses.gross_hours",
  "extra hours": "expenses.gross_hours",
  "over 8 hours": "expenses.gross_hours",
  ...
  "quote total": "quotes.total_amount",
  "quote amount": "quotes.total_amount",
  "quoted cost": "quotes.total_amount",
  "vendor quote": "quotes.total_amount",
  "quote price": "quotes.total_amount",
  "quotes": "quotes.total_amount",
  "bids": "quotes.total_amount",
  "proposals": "quotes.total_amount",
  "estimates from vendors": "quotes.total_amount",
  ...
  "expense_gross_hours": {
    ...
    "formula": "Auto-calculated by trigger: (end_time - start_time) / 3600",
    "notes": "STORED FIELD - auto-calculated by database trigger. Total shift duration before lunch deduction. Only populated for labor_internal expenses."
  },
  "expense_net_hours": {
    ...
    "notes": "Paid hours after lunch deduction. Stored in expenses.hours field. Amount = Paid Hours × Hourly Rate. Employee-facing term: \"Paid Hours\"."
  },
  ...
  "weekly_labor_total_hours": {
    "field": "weekly_labor_hours.paid_hours",
    "aliases": [
      "total hours",
      "weekly hours",
      "hours",
    ...
    "notes": "Total paid hours for the week (after lunch deductions). What employees get paid for."
  },
  "weekly_labor_gross_hours": {
    ...
    "formula": "SUM(expenses.gross_hours) for the week",
    "notes": "Total gross shift hours for the week (before lunch deductions). Aggregated from expenses.gross_hours database column."
  },
  ...
  "Time entries are rows in the `expenses` table WHERE is_time_entry = true. ALWAYS use is_time_entry = true to identify time entries — do NOT filter by category = 'labor_internal'.",
  ...
  "Cost = what RCG pays to vendors/workers. Price = what clients are charged. When comparing quotes to estimates, always use cost fields (total_cost, cost_per_unit), never price fields (total, price_per_unit).",
  "actual_margin = invoiced - expenses (REAL profit). adjusted_est_margin = contracted - adjusted estimated costs (EXPECTED profit). current_margin is deprecated — use adjusted_est_margin instead.",
  ...
  "The expenses table cost column is `amount`, NOT `total_cost`. There is no `total_cost` column on expenses. For labor cost per project, use `reporting.internal_labor_hours_by_project` which has pre-calculated `actual_cost`.",
