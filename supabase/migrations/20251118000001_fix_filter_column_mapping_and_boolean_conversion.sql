-- Fix filter issues in execute_simple_report function
-- Fix 1: Map worker_name alias to actual column (payee_name)
-- Fix 2: Convert boolean field filters from text to actual booleans
