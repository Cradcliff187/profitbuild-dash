-- Migration: Rename vendors table to payees (Fixed version)
...
-- Copy all data from vendors to payees with explicit column mapping
INSERT INTO public.payees (
    id, vendor_name, email, phone_numbers, billing_address, full_name, 
    account_number, terms, is_active, quickbooks_vendor_id, sync_status, 
