-- Add revenue variance fields to reporting.project_financials view
-- These fields compare estimated revenue (contracted_amount) vs actual revenue (total_invoiced)
...
SELECT 
  ...
  -- Revenue variance calculations (NEW)
