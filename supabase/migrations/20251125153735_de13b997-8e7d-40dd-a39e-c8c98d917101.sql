-- Fix critical bug in calculate_project_margins
-- Line 99: Change qli.estimate_line_item_id = qli.id to qli.estimate_line_item_id = eli.id
-- This bug prevented accepted quote costs from being used in adjusted cost calculations
        ...
        ELSE
          COALESCE(
            (SELECT qli.total_cost 
             ...
             WHERE qli.estimate_line_item_id = eli.id  -- FIXED: was qli.id
