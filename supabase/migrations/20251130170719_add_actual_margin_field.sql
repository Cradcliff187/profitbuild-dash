-- Add actual_margin column to projects table
-- Actual margin = total_invoiced - total_expenses (real invoices minus real expenses)
-- This is different from current_margin which = contracted_amount - total_expenses

ALTER TABLE public.projects 
ADD COLUMN IF NOT EXISTS actual_margin numeric(15,2) DEFAULT NULL;

-- Update calculate_project_margins function to calculate actual_margin
...
BEGIN
  ...
  -- Get total invoiced (real invoices from project_revenues)
...
-- Recalculate margins for all projects to populate actual_margin
DO $$
DECLARE
  project_record RECORD;
BEGIN
