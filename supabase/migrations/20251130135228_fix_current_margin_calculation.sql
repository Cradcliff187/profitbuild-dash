-- Update profit analysis function to use actual_margin from database
-- actual_margin = total_invoiced - total_expenses (real invoices minus real expenses)
-- current_margin = contracted_amount - total_expenses (contracted minus expenses)
