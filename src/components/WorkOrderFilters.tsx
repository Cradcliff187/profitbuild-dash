...
export const WorkOrderFilters = ({
  ...
  const updateFilters = (updates: Partial<WorkOrderSearchFilters>) => {
  ...
  const getActiveFilterCount = (): number => {
    ...
    if (filters.hasEstimate !== null) count++;
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
        ...
        {/* Has Estimate Filter */}
        <Select
          value={filters.hasEstimate === null ? 'all' : filters.hasEstimate ? 'yes' : 'no'}
          onValueChange={(value) => updateFilters({ 
            hasEstimate: value === 'all' ? null : value === 'yes' 
          })}
        >
          <SelectTrigger className="h-9 text-xs">
            <SelectValue placeholder="Has Estimate" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="all">All</SelectItem>
            <SelectItem value="yes">Has Estimate</SelectItem>
            <SelectItem value="no">No Estimate</SelectItem>
          </SelectContent>
        </Select>
