        ...
        <div className="mt-6 space-y-8">
          ...
          <section>
            ...
            <MarginComparisonBars
              ...
              projectedMargin={project.adjusted_est_margin ?? 0}
              currentMargin={project.actual_margin ?? 0}
            ...
            <section className="bg-muted/50 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between font-medium">
                  ...
                  <span className={(project.adjusted_est_margin ?? 0) >= 0 ? 'text-green-600' : 'text-red-600'}>
                    {formatCurrency(project.adjusted_est_margin ?? 0)}
                  </span>
                </div>
              </div>
            </section>
