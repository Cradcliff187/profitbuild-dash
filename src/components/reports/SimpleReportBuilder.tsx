...
export const AVAILABLE_FIELDS: Record<string, FieldMetadata[]> = {
  ...
  internal_costs: [
    ...
    { key: 'hours', label: 'Paid Hours', type: 'number', group: 'time', allowedOperators: ['equals', 'greater_than', 'less_than', 'between'], helpText: 'Paid hours after lunch deduction (only for internal labor)' },
  ...
  weekly_labor_hours: [
    ...
    { key: 'paid_hours', label: 'Paid Hours', type: 'number', group: 'time', allowedOperators: ['equals', 'greater_than', 'less_than', 'between'], helpText: 'Paid hours after lunch deductions (what employees get paid for). Use gross_hours for total shift duration.' },
    { key: 'gross_hours', label: 'Gross Hours', type: 'number', group: 'time', allowedOperators: ['equals', 'greater_than', 'less_than', 'between'], helpText: 'Total shift duration before lunch deduction. Use Paid Hours for billable hours.' },
