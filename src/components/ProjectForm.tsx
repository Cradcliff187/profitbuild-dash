...
export const ProjectForm = ({ onSave, onCancel }: ProjectFormProps) => {
  ...
  const [projectNumber, setProjectNumber] = useState("Auto-generated on save");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setProjectNumber(generatedNumber); // Update UI with actual number
  ...
  const regenerateProjectNumber = async () => {
    ...
    if (projectNumber === "Auto-generated on save") {
      toast({
        title: "Not Yet Generated",
        description: "Project number will be generated when you save the project.",
      });
      return;
    }
      ...
      <Card className="compact-card">
        ...
        <CardContent className="space-y-2 p-compact">
          ...
          <AutoGeneratedField
            ...
            value={projectNumber}
            onRegenerate={projectNumber === "Auto-generated on save" ? undefined : regenerateProjectNumber}
            tooltip={
              projectNumber === "Auto-generated on save"
                ? "Will be automatically generated when you create the project"
                : "Automatically generated unique project identifier"
            }
