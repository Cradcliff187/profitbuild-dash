  ...
  const loadProjects = async () => {
    try {
      ...
      const [projectsRes, estimatesRes, quotesRes, changeOrdersRes, financialsRes, coLineItemsRes] = await Promise.all([
        supabase.from('projects').select('*').or(getProjectCategoryOrFilter()).or('project_type.eq.construction_project,project_type.is.null').order('created_at', { ascending: false }),
