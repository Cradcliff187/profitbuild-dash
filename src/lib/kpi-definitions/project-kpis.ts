...
export const projectFinancialKPIs: KPIMeasure[] = [
  ...
  // ==========================================================================
  {
    ...
    dataType: 'currency',
    domain: 'project',
    whereUsed: 'ProjectDetailView, ProfitAnalysis, WorkOrders table',
  ...
  // ==========================================================================
  {
    ...
    dataType: 'currency',
    domain: 'project',
    whereUsed: 'ProjectOperationalDashboard, financial dashboards',
  ...
  // ==========================================================================
  {
    ...
    dataType: 'currency',
    domain: 'project',
    whereUsed: 'Budget planning, financial dashboards',
  ...
  },
  {
    ...
    dataType: 'currency',
    domain: 'project',
    whereUsed: 'Risk alerts, financial dashboards',
