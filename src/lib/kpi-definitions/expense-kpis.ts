...
export const expenseKPIs: KPIMeasure[] = [
  ...
  },
  {
    ...
    dataType: 'number',
    domain: 'expense',
    whereUsed: 'Time entry calculations, reports, time tracking, compliance',
    ...
    aliases: ['gross hours', 'shift hours', 'raw hours', 'clock hours'],
    relatedTo: ['expense_net_hours', 'expense_start_time', 'expense_end_time'],
    preferWhen: 'User asks about total time worked before breaks, shift duration',
    avoidWhen: 'User asks about billable hours or paid hours (use paid_hours/expense_net_hours instead)',
  },
  {
    ...
    preferWhen: 'User asks about billable/paid hours or payroll hours',
  },
